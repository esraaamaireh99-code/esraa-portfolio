...
export function ExperienceSection() {
  return (
    <section id="experience" className="relative px-5 py-16 sm:px-8 lg:px-12">
        ...
        <div className="mt-8 grid gap-6">
          {portfolio.experience.map((role, index) => (
            <MotionReveal key={`${role.company}-${role.period}`} delay={index * 0.08}>
              <article className="group relative overflow-hidden rounded-[1.5rem] border border-[#A78BFA]/25 bg-white/[0.06] p-6 shadow-lg shadow-purple-950/25 backdrop-blur-xl transition duration-200 hover:-translate-y-1 hover:border-[#A78BFA]/45 hover:shadow-2xl hover:shadow-purple-950/40">
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <p className="rounded-full bg-white/[0.06] px-4 py-2 text-sm font-semibold text-[#C4B5FD] ring-1 ring-[#A78BFA]/25">
                    {role.period}
                  </p>
                </div>
